...
public class ResourceServerSecurityConfig extends ResourceServerConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                ...
                .mvcMatchers(HttpMethod.GET, "/api/reception/**").authenticated()
                .mvcMatchers(HttpMethod.GET, "/api/clinic/**").authenticated()
                .mvcMatchers(HttpMethod.GET, "/api/patient/**").authenticated()
                .mvcMatchers(HttpMethod.GET, "/api/receipt/**").authenticated()
                .mvcMatchers(HttpMethod.GET, "/api/employee/**").authenticated()
